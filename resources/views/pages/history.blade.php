                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label></label>
                                    <input readonly type="text" value="{{isset($_GET['date']) ? date('F d,y',strtotime($_GET['date'])) : null}}" onchange="dateSearch($(this).val())" id="datepicker" class="form-control" placeholder="Choose">
                                </div>
                            </div>
                            <div class="col-md-3">
